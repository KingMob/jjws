...
@test "add mode rejects too many arguments" {
    run_jjws add myworkspace @ extraarg
...
@test "forget mode rejects too many arguments" {
    run_jjws forget workspace1 workspace2
...
@test "switch mode rejects too many arguments" {
    run_jjws switch workspace1 workspace2
